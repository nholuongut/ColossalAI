...
<br/>
   ...
   <a href="https://github.com/nholuongut/ColossalAI/tree/main/examples"> Examples </a> |
   <a href="https://github.com/nholuongut/ColossalAI/discussions"> Forum </a> |
...
[Open-Sora](https://github.com/nholuongut/Open-Sora)：Revealing Complete Model Parameters, Training Details, and Everything for Sora-like Video Generation Models
[[code]](https://github.com/nholuongut/Open-Sora)
...
[[Model weights]](https://github.com/nholuongut/Open-Sora?tab=readme-ov-file#model-weights)
[[Demo]](https://github.com/nholuongut/Open-Sora?tab=readme-ov-file#-latest-demo)
...
[[code]](https://github.com/nholuongut/ColossalAI/tree/main/applications/Colossal-LLaMA-2)
...
[ColossalChat](https://github.com/nholuongut/ColossalAI/tree/main/applications/Chat): An open-source solution for cloning [ChatGPT](https://openai.com/blog/chatgpt/) with a complete RLHF pipeline.
[[code]](https://github.com/nholuongut/ColossalAI/tree/main/applications/Chat)
...
- [Training](https://github.com/nholuongut/ColossalAI/tree/main/examples/images/diffusion): Reduce Stable Diffusion memory consumption by up to 5.6x and hardware cost by up to 46x (from A100 to RTX3060).


- [DreamBooth Fine-tuning](https://github.com/nholuongut/ColossalAI/tree/main/examples/images/dreambooth): Personalize your model using just 3-5 images of the desired subject.

<p id="inference-sd" align="center">
</p>

- [Inference](https://github.com/nholuongut/ColossalAI/tree/main/examples/images/diffusion): Reduce inference GPU memory consumption by 2.5x.
...
- [FastFold](https://github.com/nholuongut/FastFold): Accelerating training and inference on GPU Clusters, faster data processing, inference sequence containing more than 10000 residues.

<p id="FastFold-Intel" align="center">
</p>

- [FastFold with Intel](https://github.com/nholuongut/FastFold): 3x inference acceleration and 39% cost reduce.
...
[[code]](https://github.com/nholuongut/ColossalAI/tree/main/examples/language/llama)
[[GPU Cloud Playground]](https://cloud.luchentech.com/)
[[LLaMA3 Image]](https://cloud.luchentech.com/doc/docs/image/llama)
...
[[code]](https://github.com/nholuongut/ColossalAI/tree/main/examples/language/openmoe)
...
### PaLM
- [PaLM-colossalai](https://github.com/nholuongut/PaLM-colossalai): Scalable implementation of Google's Pathways Language Model ([PaLM](https://ai.googleblog.com/2022/04/pathways-language-model-palm-scaling-to.html)).
...
- 45% speedup fine-tuning OPT at low cost in lines. [[Example]](https://github.com/nholuongut/ColossalAI/tree/main/examples/language/opt) [[Online Serving]](https://colossalai.org/docs/advanced_tutorials/opt_service)

Please visit our [documentation](https://www.colossalai.org/) and [examples](https://github.com/nholuongut/ColossalAI/tree/main/examples) for more details.
...
- [Cached Embedding](https://github.com/nholuongut/CachedEmbedding), utilize software cache to train larger embedding tables with a smaller GPU memory budget.
...
[[code]](https://github.com/nholuongut/ColossalAI/tree/main/colossalai/inference)
...
[[code]](https://github.com/nholuongut/ColossalAI/tree/main/examples/language/grok-1)
...
- [SwiftInfer](https://github.com/nholuongut/SwiftInfer): Inference performance improved by 46%, open source solution breaks the length limit of LLM for multi-round conversations
...
If you encounter any problem with installation, you may want to raise an [issue](https://github.com/nholuongut/ColossalAI/issues/new/choose) in this repository.
...
You can directly pull the docker image from our [DockerHub page](https://hub.docker.com/r/nholuongut/colossalai). The image is automatically uploaded upon release.
